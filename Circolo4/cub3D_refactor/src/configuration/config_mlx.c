...
/*   Updated: 2024/07/12 17:30:18 by fcardina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	reset_image(img);
	img->img = mlx_xpm_file_to_image(game_data->mlx, file_path,
...
void	initialize_graphics(t_data *game_data)
{
	...
	game_data->win = mlx_new_window(game_data->mlx, WIN_WIDTH, WIN_HEIGHT,
			"Cub3D");
	if (!game_data->win)
