...
/*   Updated: 2024/07/12 17:29:48 by fcardina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	listen_input(t_data *game_data)
{
	...
	mlx_hook(game_data->win, KeyPress, KeyPressMask, handle_key_press,
		game_data);
	mlx_hook(game_data->win, KeyRelease, KeyReleaseMask, handle_key_release,
		game_data);
}
