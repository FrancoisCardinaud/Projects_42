...
static int	move_player_forward(t_info *data)
{
	double	new_x;
	double	new_y;
...
static int	move_player_backward(t_info *data)
{
	double	new_x;
	double	new_y;
...
static int	move_player_left(t_info *data)
{
	double	new_x;
	double	new_y;
...
static int	move_player_right(t_info *data)
{
	double	new_x;
	double	new_y;
